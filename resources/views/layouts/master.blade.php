            ...
            <ul class="tada-menu">
                @foreach ($categories as $key => $category)
                    @if($category->parent_id == null)
                     <li><a href="/category/{{$category->slug}}" class="active">{{$category->name}}<i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                             @foreach ($categories as $key => $catesub)
                            @if($catesub->parent_id == $category->id)
                        	<li><a href="/category/{{$catesub->slug}}">{{$catesub->name}}</a></li>
                            @endif                          
                            @endforeach                                                                      
                        </ul>
                    </li>
